      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url() ?>admin/dist/img/ana.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Ana Nurul Fatmawati</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url() ?>admin/dist/img/ana.jpg" class="img-circle" alt="User Image">

                <p>
                  Ana Nurul Fatmawati- Web Developer
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <center>
			<h5>
			<a href="<?php echo base_url('C_mhs/tambahmhs');?>">Tambah </a>
			</h5>
			</center>
              <table id="example1" class="table table-bordered table-striped">
               <thead>
				...
				<tr>
					...
					<td align ="center">
						<a href="<?php echo base_url('C_mhs/editmhs/').$itemmhs['id']; ?>">Edit</a>
